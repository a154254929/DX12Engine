...
FBoxMesh* FBoxMesh::CreateMesh()
{
	...
	meshRenderingData.vertexData.push_back(FVertex(XMFLOAT3(1.f, 0.f, 1.f), XMFLOAT4(Colors::Chocolate)));
	...
	//后
	meshRenderingData.indexData.push_back(4);meshRenderingData.indexData.push_back(6);meshRenderingData.indexData.push_back(7);
	meshRenderingData.indexData.push_back(4);meshRenderingData.indexData.push_back(7);meshRenderingData.indexData.push_back(8);
	//左
